...
Resolved 2026-07-17: optimize.ts (Meshopt, prune keepAttributes/keepLeaves, --simplify 0.5 chosen by visual keyframe comparison) produces assets/hologlyph-bust.glb at 654 KB, under the 1.5 MB target; validateRig re-run on the OPTIMISED GLB by test/asset-bust.test.ts; exact invocation documented in tools/asset-pipeline/README.md.
